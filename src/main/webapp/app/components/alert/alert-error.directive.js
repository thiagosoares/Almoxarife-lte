(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('montisolTeste03App.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-montisolTeste03App-error');
                var entityKey = httpResponse.headers('X-montisolTeste03App-params');
                if (errorHeader) {
